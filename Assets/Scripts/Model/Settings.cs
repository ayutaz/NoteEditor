...
namespace NoteEditor.Model
{
    public class Settings : SingletonMonoBehaviour<Settings>
    {
        ...
        ReactiveProperty<string> musicPath_ = new ReactiveProperty<string>();
        ReactiveProperty<string> notesPath_ = new ReactiveProperty<string>();
        ...
        public static ReactiveProperty<string> MusicPath { get { return Instance.musicPath_; } }
        public static ReactiveProperty<string> NotesPath { get { return Instance.notesPath_; } }
